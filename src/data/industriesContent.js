export const industriesContent = {
    "agropecuario": {
        ...
        paragraphs: [
            ...
            "Las actividades agropecuarias modernas y en proceso de modernización, de alta y baja escala y productividad, coexisten. Para maximizar la productividad y calidad, con un enfoque de sostenibilidad, las actividades agropecuarias modernas son sistemas de producción intensivos que integran tecnologías avanzadas con drones, sensores, inteligencia artificial, biotecnología, entre otros. En tanto, las actividades agropecuarias en proceso de modernización, con especialización y fuertemente ligada a las actividades agropecuarias familiares, son aquellas formas de organizar la producción agropecuaria gestionadas y operadas por familias que dependen principalmente del trabajo familiar.",
    ...
    "agroexportacion": {
        ...
        headerImagePosition: "center",
        paragraphs: [
            "Es una industria creciente cuyos productos agrícolas se comercializan globalmente, influenciado por el aumento de la población, los ingresos, la aplicación de nuevas tecnologías que amplían fronteras agrícolas, así como por la tendencia creciente en el consumo de productos naturales, frescos y saludables. Los productos de la agroexportación se tranzan en el mercado global, por lo que requieren sistemas complejos de transformación, logísticos, tarifarios y fitosanitarios.",
            "En el Centro para la Competitividad y el Desarrollo (CCD) brindamos asesoría y asesoría técnica para identificar y crear oportunidades agroexportables. Evaluamos el potencial de los productos para ser insertados en la cadena global, nacional y regional, bajo un enfoque integral que considera la comercialización, transformación o industrialización, la logística y la producción, considerando en cada uno de estos eslabones el capital, el trabajo y la productividad total de factores."
        ],
    ...
    "educacion": {
        ...
        headerImagePosition: "center",
        paragraphs: [
            "La educación adecuada y de calidad es fundamental en todo proceso de desarrollo sostenible. La educación genera importantes externalidades positivas, principalmente en los factores productivo, social y cultural. En lo productivo dinamiza la actividad económica por contar con trabajadores especializados y capacitados, con habilidades y potencial creciente, y la educación superior de calidad impulsa sustancialmente la productividad, los ingresos y los aportes al Estado por tributos. En el factor social, mayor educación genera cohesión, confianza, paz social y desarrollo, contribuye a generar sinergias sociales para ser más productivos y promueve un mayor desarrollo en los niveles individual, familiar, empresarial y Estado. En el factor cultural, la mayor educación contribuye a formar identidades individuales y colectivas, y genera mayores retornos por la experiencia intercultural.",
            "En el Centro para la Competitividad y el Desarrollo (CCD) promovemos la educación para el desarrollo y la prosperidad, con el objetivo de generar oportunidades y alta calidad de vida para todos (circunscripciones nacional, regional, provincial, distrital y comunal). Con este propósito formulamos estudios de preinversión y expedientes técnicos para la construcción de infraestructura para la educación básica regular y para la educación superior. Evaluamos, formulamos estudios e implementamos proyectos para mejorar los servicios educativos, principalmente logros de aprendizaje y educación tecnológica y digital en convenio con universidades e instituciones lideres en la materia."
        ],
    ...
    "hidrocarburos": {
        ...
        headerImagePosition: "center",
        paragraphs: [
            "El desarrollo de un proyecto en el sector hidrocarburos comprenden principalmente el proceso de obtención de los lotes, la exploración, la construcción y el desarrollo de los lotes y pozos hidrocarburiferos, la explotación, el transporte de los hidrocarburos, la transformación o refinación en destilados o combustibles y el transporte de los productos comercializables a los almacenes, a los centros productivos e industriales y a los centros de servicios para abastecer a los consumidores finales. En cada una de estas actividades las empresas del sector hidrocarburos interactúan y contribuyen con el desarrollo de la población que se encuentran directa e indirectamente relacionada. Dependiendo de cada proyecto en concreto, esta interacción entra las actividades del proyecto de hidrocarburos y la población puede circunscribirse a escalas multi países/regiones/provincias/distritos.",
    ...
    "infraestructura": {
        ...
        paragraphs: [
            ...
            "En el Centro para la Competitividad y el Desarrollo (CCD) elaboramos líneas de base, estudios de impactos, estudios de preinversión y expedientes técnicos para la construcción de infraestructura social enfocada al bienestar y a mejorar la calidad de vida como hospitales, escuelas para la educación básica regular y superior, sistemas de agua potable, alcantarillado y energía; e infraestructura económica para el desarrollo de la población directa e indirectamente relacionada, principalmente para los sectores agropecuario, banca y finanzas, electricidad, hidrocarburos, minería, seguridad, sistemas portuarios y transportes y comunicación (conectividad terrestre, fluvial, aeronáutica y virtual)."
    ...
    "publico": {
        ...
        paragraphs: [
            ...
            "Para poder realizar estas funciones de políticas públicas, el Estado recauda ingresos públicos principalmente a través de los tributos que pagan las personas y las empresas. Estos ingresos públicos deben ser establecidos por el Estado teniendo en cuenta eficiencia, neutralidad, simplicidad, transparencia, equidad horizontal y vertical y competitividad internacional.",

            "En el Centro para la Competitividad y el Desarrollo (CCD) brindamos asesoría, asistencia técnica y fortalecimiento de capacidades para el diseño, normatividad, implementación y evaluación de políticas públicas, principalmente en desarrollo, competitividad, crecimiento económico, infraestructura, planeamiento, descentralización, desarrollo de corredores económicos territoriales e inversión pública; así como en políticas fiscales vinculadas a ingresos, gastos, financiamiento y endeudamiento público, sostenibilidad fiscal, en la creación de nuevos instrumentos fiscales para el desarrollo, en fondos de desarrollo y en mecanismos aceleradores para el crecimiento sostenido de sectores económicos. Asimismo, diseñamos y apoyamos en la implementación de KPIs para funcionarios y colaboradores para la ganancia de eficiencias en las actividades del sector público, a niveles de gobiernos nacional, regional y local."
        ],
